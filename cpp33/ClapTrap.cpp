...
/*   Updated: 2025/11/03 12:32:23 by abdo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap():hit_points(0),energy_points(0),attack_damage(0)
{
...
void ClapTrap::attack(const std::string& target)
{
    if (hit_points > 0 && energy_points > 0)
    {
        ...
        std::cout << "Can't attack , it's lose point." << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (energy_points > 0)
    {
        ...
        std::cout  << "there is no energy_points" << std::endl;
}